            ...
            <div class="jumbotron">
                ...
                <div class="row clearfix">
                    <div class="col-md-12 column">
                        <div class="well">
                            <h4 class="glow in">Olá, tudo bem? Seja bem vindo ao Questionário Interativo!</h4>
                            <p class="glow in" style="font-weight: bold;">Para responder as questões,  basta  clicar e arrastar uma das opções disponíveis da área de Opções para a área de Respostas.</p>
                            ...
                            <p class="glow in">Caso queira trocar de alternativa, se acaso errar por exemplo, basta arrastá-la de volta para a área de Opções, escolher a nova opção e arrastar novamente.</p>
                        </div>
                    </div>
                </div>
            </div>
