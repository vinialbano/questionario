<?php
    ...
    class QuestionsTableSeeder extends Seeder {
        ...
        public function run()
        {
            ...
            $question->image        = "production/images/alcool.jpg";
            $question->save();
            ...
            $question = new Question;
            $question->text         = 'E ai, cara, tudo bem? To aqui tomando um energético, dizem que serve para ficar mais animado. Já tomou algum? Como Red bull, Flash Power, Flying Hourse, Bad Boy, Blue Energy, Burn.';
            $question->multianswer  = false;
            $question->allow_other   = false;
            $question->scene        = 5;
            $question->has_jump     = true;
            $question->has_image    = true;
            $question->image        = "production/images/energetico.jpg";
            $question->save();
            $question->alternative()->associate(Alternative::where('text','=','Não')->first())->save();
            ...
            $question->has_jump     = true;
            $question->has_image    = true;
            $question->image        = "production/images/cigarro.jpg";
            $question->save();
            $question->alternative()->associate(Alternative::where('text','=','Não')->first())->save();
            ...
            $question->scene        = 5;
            $question->has_image    = true;
            $question->image        = "production/images/narguile.jpg";
            $question->save();
            ...
            $question->has_jump     = true;
            $question->has_image    = true;
            $question->image        = "production/images/maconha.jpg";
            $question->save();
            $question->alternative()->associate(Alternative::where('text','=','Não')->first())->save();
            ...
            $question->has_jump     = true;
            $question->has_image    = true;
            $question->image        = "production/images/cocaina.jpg";
            $question->save();
            $question->alternative()->associate(Alternative::where('text','=','Não')->first())->save();
            ...
            $question->has_jump     = true;
            $question->has_image    = true;
            $question->image        = "production/images/akineton.jpg";
            $question->save();
            $question->alternative()->associate(Alternative::where('text','=','Não')->first())->save();
            ...
            $question->has_jump     = true;
            $question->has_image    = true;
            $question->image        = "production/images/crack.jpg";
            $question->save();
            $question->alternative()->associate(Alternative::where('text','=','Não')->first())->save();
            ...
            $question->has_jump     = true;
            $question->has_image    = true;
            $question->image        = "production/images/removedor.jpg";
            $question->save();
            $question->alternative()->associate(Alternative::where('text','=','Não')->first())->save();
            ...
            $question->scene        = 10;
            $question->has_image    = true;
            $question->image        = "production/images/heroina.jpg";
            $question->save();
            ...
            $question->scene        = 10;
            $question->has_image    = true;
            $question->image        = "production/images/cogumelo.jpg";
            $question->save();
            ...
            $question->scene        = 10;
            $question->has_image    = true;
            $question->image        = "production/images/extase.jpg";
            $question->save();
            ...
            $question->scene        = 10;
            $question->has_image    = true;
            $question->image        = "production/images/benflogin.jpg";
            $question->save();
            ...
            $question->has_jump     = true;
            $question->has_image    = true;
            $question->image        = "production/images/inibex.jpg";
            $question->save();
            $question->alternative()->associate(Alternative::where('text','=','Não')->first())->save();
            ...
            $question->scene        = 11;
            $question->has_image    = true;
            $question->image        = "production/images/carpinol.jpg";
            $question->save();
            ...
            $question->has_jump     = true;
            $question->has_image    = true;
            $question->image        = "production/images/diazepam.jpg";
            $question->save();
            $question->alternative()->associate(Alternative::where('text','=','Não')->first())->save();
            ...
            $question->scene        = 11;
            $question->has_image    = true;
            $question->image        = "production/images/tylex.jpg";
            $question->save();
            ...
            $question->scene        = 11;
            $question->has_image    = true;
            $question->image        = "production/images/equipoise.jpg";
            $question->save();
            ...
            $question = Question::where('text', '=', 'E ai, cara, tudo bem? To aqui tomando um energético, dizem que serve para ficar mais animado. Já tomou algum? Como Red bull, Flash Power, Flying Hourse, Bad Boy, Blue Energy, Burn.')->first();
